...
namespace GeneratorNote.DTOs
{
    ...
    public class Det
    {
        ...
        [XmlElement(ElementName = "infAdProd", Namespace = "http://www.portalfiscal.inf.br/nfe")]
    ...
    [XmlRoot(ElementName = "card", Namespace = "http://www.portalfiscal.inf.br/nfe")]
    public class Card
    {
        [XmlElement(ElementName = "tpIntegra", Namespace = "http://www.portalfiscal.inf.br/nfe")]
        public string TpIntegra { get; set; }
        [XmlElement(ElementName = "CNPJ", Namespace = "http://www.portalfiscal.inf.br/nfe")]
        public string CNPJ { get; set; }
        [XmlElement(ElementName = "tBand", Namespace = "http://www.portalfiscal.inf.br/nfe")]
        public string TBand { get; set; }
        [XmlElement(ElementName = "cAut", Namespace = "http://www.portalfiscal.inf.br/nfe")]
    ...
    public class DetPag
    {
        ...
        [XmlElement(ElementName = "card", Namespace = "http://www.portalfiscal.inf.br/nfe")]
